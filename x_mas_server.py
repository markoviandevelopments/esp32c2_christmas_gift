...
# Crypto data + Git sync + auto-compile + FULL round-screen photo server
...
PHOTO_DIRS = {
    "screen1": os.path.join(BASE_DIR, 'photos', 'circle_display_1'),  # Pattie
    "screen2": os.path.join(BASE_DIR, 'photos', 'circle_display_2'),  # Melanie
    "screen3": os.path.join(BASE_DIR, 'photos', 'circle_display_3'),  # Robbins
    "screen4": os.path.join(BASE_DIR, 'photos', 'circle_display_4'),  # Preston and Willoh
}
TARGET_SIZE = 240
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=9019, debug=False)# x_mas_server.py - FULL MERGED SERVER (Git sync + auto-compile + ALL data endpoints)
