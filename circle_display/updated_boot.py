# updated_boot.py - Circle-display version + DNS-only + long-hostname fix
import asyncio
import bluetooth
import gc
import machine
...
provisioned_server_ip = 'ghostshrimp.immenseaccumulationonline.online'  # ← new DNS default
provisioned_server_port = ''  # no longer used
...
async def download_tertiary():
    url = f'http://{provisioned_server_ip}/tertiary.mpy'   # ← pure DNS, no port
